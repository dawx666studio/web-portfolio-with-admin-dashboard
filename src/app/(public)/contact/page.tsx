...
import { Instagram, Twitch, Sparkles } from "lucide-react";

export default function ContactPage() {
  return (
    <div className="bg-fructus-red text-white py-16 sm:py-24 px-4 sm:px-6 lg:px-8 min-h-[85vh] flex items-center">
